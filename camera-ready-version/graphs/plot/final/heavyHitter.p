...
set label "Traffic burst" at 2,700 nopoint tc lt 6
set arrow from 15,0 to 15,680 nohead lt 6 lw 3

plot 'heavyHitter.dat' using 4:xtic(int($0)%5 == 0 ? stringcolumn(1) : '')  title 'SoftUPF'  ls 7 lw 4 w linespoints ,\
	'heavyHitter.dat' using 7 title 'SteerOffload' ls -1 dt 2 lw 4 w linespoints   
